...
public class MarketController implements Initializable {
    ...
    private List <Fruit> getData(){
        ...
        fruit.setPrice (4.99);
        fruit.setImgSrc ("/img/img_10.png");
        ...
        fruit.setPrice (1.99);
        fruit.setImgSrc ("/img/bannana_1.jpg");
    ...
    private void setChosenFruit(Fruit fruit){
        ...
        fruitPriseLabel.setText (Main.CURRENCY + fruit.getPrice ());
        image = new Image(fruit.getClass ().getResourceAsStream (fruit.getImgSrc ()));
